...
COS_PP_DECR(5)
COS_PP_DECR(COS_PP_DECR(5))
COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(5)))
COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(5))))
COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(5)))))
COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(COS_PP_DECR(5))))))
